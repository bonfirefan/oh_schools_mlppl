CREATE MATERIALIZED VIEW sketch.train_data_2 AS
select
	snap.student_lookup,
	snap.grade as grade,
...
grant select on sketch.train_data_2 to public;
grant delete on sketch.train_data_2 to cchallu;
grant delete on sketch.train_data_2 to sduran;